				...
				onReady: function() {
					...
					var form_html = '<div class="trx_addons_ai_elm_gen_text_msg_inner">\
							<div class="trx_addons_ai_elm_gen_text_msg_input">\
								...
								<input type="text" id="trx_addons_ai_elm_gen_text_msg_input_purpose" class="trx_addons_ai_elm_gen_text_msg_input_purpose" value="' + TRX_ADDONS_STORAGE['elm_ai_generate_text_modal_purpose_pl'] + '" />\
							</div>\
							<div class="trx_addons_ai_elm_gen_text_msg_input">\
