	...
	#><div id="{{ id }}"
		...
		#>"><#
			...
			if (settings.hide_prev == 0) { 
				#><a class="slider_prev <# if (settings.title_prev != '') print(' with_title'); #> {{ arrow_prev }}" href="#" role="button">{{ settings.title_prev }}</a><#
			}
			if (settings.hide_next == 0) { 
				#><a class="slider_next <# if (settings.title_next != '') print(' with_title'); #> {{ arrow_next }}" href="#" role="button">{{ settings.title_next }}</a><#
			}
