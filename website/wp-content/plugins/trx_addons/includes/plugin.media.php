				...
				$output .= 				'</div>'
								...
								. ( trx_addons_is_on( $args['controller_controls'] )
									? '<div class="slider_controls_wrap slider_controller_arrows_wrap">'
											. '<a class="slider_prev ' . esc_attr( $arrow_prev ) . ' swiper-button-prev" href="#" role="button"></a>'
											. '<a class="slider_next ' . esc_attr( $arrow_next ) . ' swiper-button-next" href="#" role="button"></a></div>'
									: ''
									)
							. '</div>'
						. '</div>';
