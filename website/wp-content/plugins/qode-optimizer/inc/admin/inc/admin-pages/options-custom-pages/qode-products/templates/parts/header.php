...
<div class="qodef-custom-page-header">
	...
	<h1><?php esc_html_e( 'All Qode Products', 'qode-optimizer' ); ?></h1>
	<p><?php esc_html_e( 'Plugins and website templates with powerful options & features for creating all types of websites', 'qode-optimizer' ); ?></p>
</div>
