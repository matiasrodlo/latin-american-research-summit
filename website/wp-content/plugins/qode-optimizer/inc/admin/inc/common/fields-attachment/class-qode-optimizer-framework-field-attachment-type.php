...
abstract class Qode_Optimizer_Framework_Field_Attachment_Type {
	...
	public function __construct( $params ) {
		...
		$value           = qode_optimizer_framework_get_option_value( '', $this->type, $this->name, $this->default_value, $this->post_id );
		$params['value'] = $value;
