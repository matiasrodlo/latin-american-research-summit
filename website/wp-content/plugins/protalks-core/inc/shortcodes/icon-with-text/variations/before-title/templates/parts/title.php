	...
	<<?php echo protalks_core_escape_title_tag( $title_tag ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> class="qodef-m-title" <?php qode_framework_inline_style( $title_styles ); ?>>
		...
		<?php endif; ?>
			<span class="qodef-m-title-inner">
				<span class="qodef-m-icon-wrapper" <?php qode_framework_inline_style( $image_styles ); ?>>
					<?php protalks_core_template_part( 'shortcodes/icon-with-text/variations/before-title', 'templates/parts/' . $icon_type, '', $params ); ?>
				</span>
