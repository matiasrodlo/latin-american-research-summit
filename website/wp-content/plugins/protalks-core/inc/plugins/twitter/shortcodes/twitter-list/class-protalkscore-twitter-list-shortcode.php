...
if ( ! function_exists( 'protalks_core_add_twitter_list_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function protalks_core_add_twitter_list_shortcode( $shortcodes ) {
		if ( qode_framework_is_installed( 'twitter' ) ) {
			$shortcodes[] = 'ProTalksCore_Twitter_List_Shortcode';
		}

		return $shortcodes;
	}

	add_filter( 'protalks_core_filter_register_shortcodes', 'protalks_core_add_twitter_list_shortcode' );
}

if ( class_exists( 'ProTalksCore_List_Shortcode' ) ) {
	class ProTalksCore_Twitter_List_Shortcode extends ProTalksCore_List_Shortcode {

		public function map_shortcode() {
			$this->set_shortcode_path( PROTALKS_CORE_PLUGINS_URL_PATH . '/twitter/shortcodes/twitter-list' );
			$this->set_base( 'protalks_core_twitter_list' );
			$this->set_name( esc_html__( 'Twitter List', 'protalks-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays twitter list', 'protalks-core' ) );
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'custom_class',
			...
			$this->set_option(
				array(
					...
					'field_type' => 'text',
					'title'      => esc_html__( 'Number of Tweets', 'protalks-core' ),
					'group'      => esc_html__( 'Info', 'protalks-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Retweeted Text', 'protalks-core' ),
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Avatar Image', 'protalks-core' ),
					'options'       => protalks_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'protalks-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Author Name', 'protalks-core' ),
					'options'       => protalks_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'protalks-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Tweet Text', 'protalks-core' ),
					'options'       => protalks_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'protalks-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Media Placeholder', 'protalks-core' ),
			...
			$this->set_option(
				array(
					'name'          => 'show_date',
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Date', 'protalks-core' ),
					'options'       => protalks_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'protalks-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Tweet Actions', 'protalks-core' ),
					'options'       => protalks_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'protalks-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Twitter Link', 'protalks-core' ),
					'options'       => protalks_core_get_select_type_options_pool( 'no_yes' ),
					'default_value' => 'no',
					'group'         => esc_html__( 'Info', 'protalks-core' ),
				)
		...
		public static function call_shortcode( $params ) {
			$html = qode_framework_call_shortcode( 'protalks_core_twitter_list', $params );
			$html = str_replace( "\n", '', $html );
		...
		public function render( $options, $content = null ) {
			...
			return protalks_core_get_template_part( 'plugins/twitter/shortcodes/twitter-list', 'templates/twitter-list', '', $atts );
		}
