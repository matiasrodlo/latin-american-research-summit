			...
			<li class="qodef-woo-mini-cart-item qodef-e">
				...
				echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					...
					sprintf(
						...
						esc_attr__( 'Remove this item', 'protalks-core' ),
						esc_attr( $product_id ),
						esc_attr( $cart_item_key ),
						esc_attr( $_product->get_sku() ),
						protalks_core_get_svg_icon( 'close' )
					),
					$cart_item_key
				);
				?>
				...
				<div class="qodef-e-content">
					...
					<p class="qodef-e-price">
						<?php echo apply_filters( 'woocommerce_cart_item_price', WC()->cart->get_product_price( $_product ), $cart_item, $cart_item_key ); ?><span class="qodef-e-quantity"><?php printf( esc_html__( 'x%s', 'protalks-core' ), esc_attr( $cart_item['quantity'] ) ); ?></span>
					</p>
				</div>
			</li>
			<?php
