...
if ( ! function_exists( 'protalks_core_add_font_awesome_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function protalks_core_add_font_awesome_to_collection( $icons ) {
		$icons[] = 'ProTalksCore_Font_Awesome_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'protalks_core_add_font_awesome_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class ProTalksCore_Font_Awesome_Pack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return PROTALKS_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/all.min.css';
		}
		...
		private function icons_array() {
			return array_flip(
				array(
					...
					"Brain"                                      => "fa fa-brain",
					"Brave"                                      => "fab fa-brave",
					"Brave Reverse"                              => "fab fa-brave-reverse",
					...
					"Google Scholar"                             => "fab fa-google-scholar",
					...
					"Signal"                                     => "fa fa-signal",
					"Signal Messenger"                           => "fab fa-signal-messenger",
					...
					"Square Letterboxd"                          => "fab fa-square-letterboxd",
					...
					"Square Upwork"                              => "fab fa-square-upwork",
					"Square Viadeo"                              => "fab fa-square-viadeo",
					"Square Vimeo"                               => "fab fa-square-vimeo",
					"Square Virus"                               => "fa fa-square-virus",
					"Square Web Awesome"                         => "fab fa-square-web-awesome",
					"Square Web Awesome Stroke"                  => "fab fa-square-web-awesome-stroke",
					...
					"Table Cells Column Lock"                    => "fa fa-table-cells-column-lock",
					"Table Cells Large"                          => "fa fa-table-cells-large",
					"Table Cells Row Lock"                       => "fa fa-table-cells-row-lock",
					...
					"Waze"                                       => "fab fa-waze",
					"Web Awesome"                                => "fab fa-web-awesome",
					"Webflow"                                    => "fab fa-webflow",
		...
		public function specific_icons() {
			return apply_filters(
				'protalks_core_filter_font_awesome_specific_icons',
				array(
					'search'        => 'fa fa-search',
		...
		public function get_new_icons_list() {
			$icons = '';

			if ( file_exists( PROTALKS_CORE_INC_PATH . '/icons/' . $this->get_base() . '/icons.json' ) ) {
				$new_icons = @file_get_contents( PROTALKS_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/icons.json' );
