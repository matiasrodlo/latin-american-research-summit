...
if ( ! function_exists( 'protalks_core_add_side_area_mobile_header_options' ) ) {
	/**
	 ...
	 */
	function protalks_core_add_side_area_mobile_header_options( $page, $general_tab ) {
	...
	add_action( 'protalks_core_action_after_mobile_header_options_map', 'protalks_core_add_side_area_mobile_header_options', 10, 2 );
}
