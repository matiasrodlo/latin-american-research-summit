...
if ( ! function_exists( 'protalks_core_add_mobile_header_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function protalks_core_add_mobile_header_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'slug'        => 'mobile-header',
				'icon'        => 'fa fa-cog',
				'title'       => esc_html__( 'Mobile Header', 'protalks-core' ),
				'description' => esc_html__( 'Global Mobile Header Options', 'protalks-core' ),
			)
		);
		...
		if ( $page ) {
			...
			$general_tab->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Sticky Mobile Header', 'protalks-core' ),
					'description'   => esc_html__( 'Set mobile header to be sticky', 'protalks-core' ),
				)
			);
			...
			$general_tab->add_field_element(
				array(
					...
					'options'       => apply_filters( 'protalks_core_filter_mobile_header_layout_option', array() ),
				)
			);
			...
			$section_svg_path->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Mobile Menu Open Icon SVG Path', 'protalks-core' ),
					'description' => esc_html__( 'Enter your mobile menu open icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'protalks-core' ),
				)
			);
			...
			$section_svg_path->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Mobile Menu Close Icon SVG Path', 'protalks-core' ),
					'description' => esc_html__( 'Enter your mobile menu close icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'protalks-core' ),
				)
			);
			...
			do_action( 'protalks_core_action_after_mobile_header_options_map', $page, $general_tab );
		}
	}

	add_action( 'protalks_core_action_default_options_init', 'protalks_core_add_mobile_header_options', protalks_core_get_admin_options_map_position( 'mobile-header' ) );
}
