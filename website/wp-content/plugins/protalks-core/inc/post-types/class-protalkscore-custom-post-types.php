...
if ( ! class_exists( 'ProTalksCore_Custom_Post_Types' ) ) {
	class ProTalksCore_Custom_Post_Types {
		...
		/**
		 * @return ProTalksCore_Custom_Post_Types
		 */
		...
		public function init() {
			...
			include_once PROTALKS_CORE_CPT_PATH . '/dashboard/customizer/post-types-customizer-options.php';
		}

		public function set_enabled_post_types() {
			...
			do_action( 'protalks_core_action_add_custom_post_type', $this );
		}

		public function include_register_files() {
		...
		public function register_post_types() {
			...
			$cpts           = apply_filters( 'protalks_core_filter_register_custom_post_types', array() );
		...
		public function include_taxonomies() {
			...
			do_action( 'protalks_core_action_include_cpt_tax_fields' );
		}

		public function register_taxonomies() {
			// Hook to include custom post types taxonomy fields.
			do_action( 'protalks_core_action_register_cpt_tax_fields' );
		}
	...
	ProTalksCore_Custom_Post_Types::get_instance();
}
