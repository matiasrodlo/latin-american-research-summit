...
abstract class QodeFrameworkFieldType {
	...
	public function render() {
		?>
		<div class="<?php echo esc_attr( $this->params['class'] ); ?>" id="qodef_<?php echo esc_attr( $this->params['id'] ); ?>" <?php qode_framework_inline_attrs( $this->params['dependency_data'], true ); ?>>
