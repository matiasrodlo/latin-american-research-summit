...
if ( ! function_exists( 'protalks_get_filter_items' ) ) {
	/**
	 ...
	 * @return array
	 */
	function protalks_get_filter_items( $params ) {
		...
		return apply_filters( 'protalks_filter_get_filter_items', $items, $params );
	}
}
