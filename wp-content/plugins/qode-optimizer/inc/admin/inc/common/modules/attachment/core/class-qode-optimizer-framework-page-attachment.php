...
class Qode_Optimizer_Framework_Page_Attachment extends Qode_Optimizer_Framework_Page {
	...
	public function add_field_element( $params ) {
		...
		qode_optimizer_framework_get_framework_root()->get_attachment_options()->set_option( $params['name'], $params['default_value'], $params['field_type'] );
