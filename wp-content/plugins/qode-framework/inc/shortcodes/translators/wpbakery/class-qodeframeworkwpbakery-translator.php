...
class QodeFrameworkWPBakery_Translator {
	...
	public function __construct() {
		...
		add_filter( 'qode_framework_filter_shortcode_content_html', array( $this, 'format_shortcode_content' ) );
	...
	public function enqueue_scripts() {
		wp_enqueue_style( 'qode-framework-wpbakery', QODE_FRAMEWORK_SHORTCODES_URL_PATH . '/translators/wpbakery/assets/css/wpbakery.css', array(), QODE_FRAMEWORK_VERSION );
	}
