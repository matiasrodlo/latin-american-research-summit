...
class QodeFrameworkFieldNumber extends QodeFrameworkFieldType {
	...
	<?php endif; ?>
		...
		<?php endif; ?>
		<input type="number" <?php qode_framework_inline_attrs( $this->data_attrs ); ?> class="qodef-field qodef-input" name="<?php echo esc_attr( $this->name ); ?>" value="<?php echo esc_attr( esc_html( $this->params['value'] ) ) ?>" min="<?php echo esc_attr( $min ); ?>" max="<?php echo esc_attr( $max ); ?>"
			<?php
