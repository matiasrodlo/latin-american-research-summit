...
class QodeFrameworkFieldPassword extends QodeFrameworkFieldType {
	...
	public function render_field() { ?>
		...
		<?php endif; ?>
		<input type="password" <?php qode_framework_inline_attrs( $this->data_attrs ); ?> class="qodef-field qodef-input" name="<?php echo esc_attr( $this->name ); ?>" value="<?php echo esc_attr( esc_html( $this->params['value'] ) ); ?>"/>
