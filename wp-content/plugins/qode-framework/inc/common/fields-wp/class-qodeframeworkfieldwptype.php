...
abstract class QodeFrameworkFieldWPType {
	...
	public function __construct( $params ) {
		...
		if ( ! empty( $this->dependency ) ) {
			...
			$hide = array_key_exists( 'hide', $this->dependency ) ? qode_framework_return_dependency_options_array( '', $this->type, $this->dependency['hide'] ) : array();
	...
	public function render() {
		if ( 'div' === $this->params['layout'] ) { ?>
			<div class="<?php echo esc_attr( $this->params['row_class'] ); ?>" <?php qode_framework_inline_attrs( $this->params['dependency_data'], true ); ?>>
				...
				<div class="qodef-input-holder qodef-field-content">
					...
					echo qode_framework_wp_kses_html( 'html', $this->render_field() );
					?>
				</div>
				<p class="description">
			...
			?>
			<tr class="<?php echo esc_attr( $this->params['row_class'] ); ?>" <?php qode_framework_inline_attrs( $this->params['dependency_data'], true ); ?>>
				<th scope="row">
