...
class ProTalksCore_Elementor_Section_Handler {
	...
	/**
	 * @return ProTalksCore_Elementor_Section_Handler
	 */
	...
	public function render_background_text_options( $column, $args ) {
		$column->start_controls_section(
			...
			array(
				'label' => esc_html__( 'ProTalks Core Background Text', 'protalks-core' ),
				'tab'   => \Elementor\Controls_Manager::TAB_ADVANCED,
			)
		);
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Enable Background Text', 'protalks-core' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'default'     => 'no',
				'options'     => array(
					'no'  => esc_html__( 'No', 'protalks-core' ),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text', 'protalks-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Color', 'protalks-core' ),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Size (px)', 'protalks-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Size - between 1512 and 1369 (px)', 'protalks-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Size - between 1368 and 1201 (px)', 'protalks-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Text Size - from 1200 (px)', 'protalks-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Offset (px)', 'protalks-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Offset - between 1512 and 1369 (px)', 'protalks-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Offset - between 1368 and 1201 (px)', 'protalks-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Offset - from 1200 (px)', 'protalks-core' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Horizontal Align', 'protalks-core' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'default'     => 'flex-start',
				'options'     => array(
					'flex-start' => esc_html__( 'Left', 'protalks-core' ),
					'center'     => esc_html__( 'Center', 'protalks-core' ),
					'flex-end'   => esc_html__( 'Right', 'protalks-core' ),
				),
				'condition'   => array(
					'qodef_background_text_enable' => 'yes',
				),
		...
		$column->add_control(
			...
			array(
				'label'       => esc_html__( 'Vertical Align', 'protalks-core' ),
				'type'        => \Elementor\Controls_Manager::SELECT,
				'default'     => 'flex-start',
				'options'     => array(
					'flex-start' => esc_html__( 'Top', 'protalks-core' ),
					'center'     => esc_html__( 'Middle', 'protalks-core' ),
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'protalks-core-elementor', PROTALKS_CORE_PLUGINS_URL_PATH . '/elementor/assets/js/elementor.min.js', array( 'jquery', 'elementor-frontend' ) );
...
if ( ! function_exists( 'protalks_core_init_elementor_section_handler' ) ) {
	/**
	 * Function that initialize main page builder handler
	 */
	function protalks_core_init_elementor_section_handler() {
		ProTalksCore_Elementor_Section_Handler::get_instance();
	}

	add_action( 'init', 'protalks_core_init_elementor_section_handler', 1 );
}
