...
if ( ! function_exists( 'protalks_core_add_mobile_logo_options' ) ) {
	/**
	 ...
	 */
	function protalks_core_add_mobile_logo_options( $page, $mobile_header_tab ) {
		...
		if ( $page ) {
			...
			$mobile_header_tab = $page->add_tab_element(
				array(
					...
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Mobile Header Logo Options', 'protalks-core' ),
					'description' => esc_html__( 'Set options for mobile headers', 'protalks-core' ),
				)
			);
			...
			$mobile_header_tab->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Mobile Logo Height', 'protalks-core' ),
					'description' => esc_html__( 'Enter mobile logo height', 'protalks-core' ),
					'args'        => array(
			...
			$mobile_header_tab->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Mobile Logo Padding', 'protalks-core' ),
					'description' => esc_html__( 'Enter mobile logo padding value (top right bottom left)', 'protalks-core' ),
				)
			);
			...
			$mobile_header_tab->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Mobile Logo Source', 'protalks-core' ),
					'options'       => array(
			...
			$logo_image_section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Mobile Logo - Main', 'protalks-core' ),
					'description'   => esc_html__( 'Choose main mobile logo image', 'protalks-core' ),
			...
			do_action( 'protalks_core_action_after_mobile_logo_image_section_options_map', $page, $mobile_header_tab, $logo_image_section );
			...
			// Hook to include additional options after section part.
			do_action( 'protalks_core_action_after_mobile_logo_svg_path_section_options_map', $page, $mobile_header_tab, $logo_svg_path_section );
			...
			// Hook to include additional options after section part.
			do_action( 'protalks_core_action_after_mobile_logo_textual_section_options_map', $page, $mobile_header_tab, $logo_textual_section );

			do_action( 'protalks_core_action_after_mobile_logo_options_map', $page );
		}
	}

	add_action( 'protalks_core_action_after_header_logo_options_map', 'protalks_core_add_mobile_logo_options', 10, 2 );
}
