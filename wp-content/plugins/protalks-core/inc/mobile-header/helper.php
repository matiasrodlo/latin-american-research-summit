...
if ( ! function_exists( 'protalks_core_dependency_for_mobile_menu_typography_options' ) ) {
	/**
	 * Function that set dependency values for module global options
	 *
	 * @return array
	 */
	function protalks_core_dependency_for_mobile_menu_typography_options() {
		return apply_filters( 'protalks_core_filter_mobile_menu_typography_hide_option', array() );
	}
}

if ( ! function_exists( 'protalks_core_set_mobile_header_styles' ) ) {
	/**
	 ...
	 * @return string
	 */
	function protalks_core_set_mobile_header_styles( $style ) {
		$opener_styles    = array();
		$opener_color     = protalks_core_get_post_value_through_levels( 'qodef_mobile_header_opener_color' );
		$opener_icon_size = protalks_core_get_post_value_through_levels( 'qodef_mobile_header_opener_size' );
		...
		$opener_hover_color  = protalks_core_get_post_value_through_levels( 'qodef_mobile_header_opener_hover_color' );
	...
	add_filter( 'protalks_filter_add_inline_style', 'protalks_core_set_mobile_header_styles' );
}
