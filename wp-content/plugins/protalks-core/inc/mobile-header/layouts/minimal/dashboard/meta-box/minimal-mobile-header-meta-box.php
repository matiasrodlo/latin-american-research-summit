...
if ( ! function_exists( 'protalks_core_add_minimal_mobile_header_meta' ) ) {
	/**
	 * Function that add additional header layout options
	 *
	 * @param object $page
	 */
	function protalks_core_add_minimal_mobile_header_meta( $page ) {
	...
	add_action( 'protalks_core_action_after_page_mobile_header_meta_map', 'protalks_core_add_minimal_mobile_header_meta', 10, 2 );
}
