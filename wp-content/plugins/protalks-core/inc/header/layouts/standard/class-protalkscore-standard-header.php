...
class ProTalksCore_Standard_Header extends ProTalksCore_Header {
	...
	/**
	 * @return ProTalksCore_Standard_Header
	 */
	...
	public function get_menu_position() {
		return protalks_core_get_post_value_through_levels( 'qodef_standard_header_menu_position' );
	}
