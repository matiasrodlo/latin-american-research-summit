...
if ( ! class_exists( 'ProTalksCore_Dashboard_Rest_API' ) ) {
	 ...
	 */
	class ProTalksCore_Dashboard_Rest_API {
		...
		public function __construct() {
			...
			add_filter( 'protalks_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
		...
		/**
		 * @return ProTalksCore_Dashboard_Rest_API
		 */
	...
	ProTalksCore_Dashboard_Rest_API::get_instance();
}
