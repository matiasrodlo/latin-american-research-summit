...
if ( ! function_exists( 'protalks_core_add_h2_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function protalks_core_add_h2_typography_options( $page ) {
		...
		if ( $page ) {
			$h2_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h2',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H2 Typography', 'protalks-core' ),
					'description' => esc_html__( 'Set values for Heading 2 HTML element', 'protalks-core' ),
				)
			);
			...
			/* 1512 styles */
			$h2_1512_typography_section = $h2_tab->add_section_element(
				array(
					'name'  => 'qodef_responsive_1512_typography_h2',
					'title' => esc_html__( 'Responsive 1512 Typography', 'protalks-core' ),
				)
			);

			$responsive_1512_typography_h2_row = $h2_1512_typography_section->add_row_element(
				array(
					'name' => 'qodef_responsive_1512_h2_typography_row',
				)
			);

			$responsive_1512_typography_h2_row->add_field_element(
				array(
					'field_type' => 'text',
					'name'       => 'qodef_h2_responsive_1512_font_size',
					'title'      => esc_html__( 'Font Size', 'protalks-core' ),
					'args'       => array(
						'col_width' => 4,
					),
			...
			$responsive_1512_typography_h2_row->add_field_element(
				array(
					'field_type' => 'text',
					'name'       => 'qodef_h2_responsive_1512_line_height',
					'title'      => esc_html__( 'Line Height', 'protalks-core' ),
					'args'       => array(
						'col_width' => 4,
					),
			...
			$responsive_1512_typography_h2_row->add_field_element(
				array(
					'field_type' => 'text',
					'name'       => 'qodef_h2_responsive_1512_letter_spacing',
					'title'      => esc_html__( 'Letter Spacing', 'protalks-core' ),
					'args'       => array(
						'col_width' => 4,
					),
	...
	add_action( 'protalks_core_action_after_typography_options_map', 'protalks_core_add_h2_typography_options' );
}
