...
if ( ! class_exists( 'ProTalksCore_Shortcodes' ) ) {
	class ProTalksCore_Shortcodes {
		...
		/**
		 * @return ProTalksCore_Shortcodes
		 */
		...
		public function init() {
			...
			include_once PROTALKS_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		public function include_shortcode_classes() {
			include_once PROTALKS_CORE_SHORTCODES_PATH . '/class-protalkscore-shortcode.php';
			include_once PROTALKS_CORE_SHORTCODES_PATH . '/class-protalkscore-list-shortcode.php';
		}
		...
		public function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'protalks_core_filter_register_shortcodes', array() );
		...
		public function include_shortcodes_widget() {
			$shortcodes = $this->get_allowed_shortcodes();
		...
		public function include_shortcodes_media_fields() {
			$shortcodes = $this->get_allowed_shortcodes();
	...
	ProTalksCore_Shortcodes::get_instance();
}
