<li>
	<div class="<?php echo esc_attr( $comment_class ); ?>">
		<?php if ( ! $is_pingback_comment ) { ?>
			<div class="qodef-comment-image"> <?php echo qode_framework_get_image_html_from_src( get_avatar( $comment, 'thumbnail' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?> </div>
		<?php } ?>
						...
						<?php if ( ! isset( $rating['show'] ) || ( isset( $rating['show'] ) && $rating['show'] ) ) { ?>
							<span class="qodef-rating-inner">
								...
								<span class="qodef-rating-value">
									...
									echo protalks_core_reviews_get_rating_html( '', $review_rating, 0 );
									?>
								</span>
							</span>
						<?php } ?>
