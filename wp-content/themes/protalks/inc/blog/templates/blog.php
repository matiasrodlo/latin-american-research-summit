...
<div class="qodef-grid-item <?php echo esc_attr( protalks_get_page_content_sidebar_classes() ); ?>">
	...
	do_action( 'protalks_action_before_blog_loop' );
	?>
	<div class="qodef-blog qodef-m <?php echo esc_attr( protalks_get_blog_holder_classes() ); ?>">
		<?php
		// Include posts loop.
		protalks_template_part( 'blog', 'templates/parts/loop' );
